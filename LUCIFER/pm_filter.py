...
@Client.on_message(filters.private & filters.text & filters.group & filters.incoming & filters.user(AUTH_USERS) if AUTH_USERS else filters.private & filters.text & filters.incoming)
